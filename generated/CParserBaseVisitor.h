...
public:
  ...
  virtual std::any visitPredefinedConstant(CParser::PredefinedConstantContext *ctx) override {
    return visitChildren(ctx);
  }
  ...
  virtual std::any visitExprList(CParser::ExprListContext *ctx) override {
    return visitChildren(ctx);
  }
  ...
  virtual std::any visitAttributeDeclaration(CParser::AttributeDeclarationContext *ctx) override {
    return visitChildren(ctx);
  }
  ...
  virtual std::any visitMemberDeclarationList(CParser::MemberDeclarationListContext *ctx) override {
    return visitChildren(ctx);
  }

  virtual std::any visitMemberDeclaration(CParser::MemberDeclarationContext *ctx) override {
    return visitChildren(ctx);
  }
  ...
  virtual std::any visitTypeSpecifierQualifier(CParser::TypeSpecifierQualifierContext *ctx) override {
    return visitChildren(ctx);
  }

  virtual std::any visitMemberDeclaratorList(CParser::MemberDeclaratorListContext *ctx) override {
    return visitChildren(ctx);
  }

  virtual std::any visitMemberDeclarator(CParser::MemberDeclaratorContext *ctx) override {
    return visitChildren(ctx);
  }
  ...
  virtual std::any visitEnumTypeSpecifier(CParser::EnumTypeSpecifierContext *ctx) override {
    return visitChildren(ctx);
  }
  ...
  virtual std::any visitTypeofSpecifier(CParser::TypeofSpecifierContext *ctx) override {
    return visitChildren(ctx);
  }

  virtual std::any visitTypeofSpecifierArgument(CParser::TypeofSpecifierArgumentContext *ctx) override {
    return visitChildren(ctx);
  }
  ...
  virtual std::any visitAttributeSpecifierSequence(CParser::AttributeSpecifierSequenceContext *ctx) override {
    return visitChildren(ctx);
  }

  virtual std::any visitAttributeSpecifier(CParser::AttributeSpecifierContext *ctx) override {
    return visitChildren(ctx);
  }

  virtual std::any visitAttributeList(CParser::AttributeListContext *ctx) override {
    return visitChildren(ctx);
  }

  virtual std::any visitAttribute(CParser::AttributeContext *ctx) override {
    return visitChildren(ctx);
  }

  virtual std::any visitAttributeToken(CParser::AttributeTokenContext *ctx) override {
    return visitChildren(ctx);
  }

  virtual std::any visitAttributeArgumentClause(CParser::AttributeArgumentClauseContext *ctx) override {
    return visitChildren(ctx);
  }

  virtual std::any visitBalancedTokenSequence(CParser::BalancedTokenSequenceContext *ctx) override {
    return visitChildren(ctx);
  }

  virtual std::any visitBalancedToken(CParser::BalancedTokenContext *ctx) override {
    return visitChildren(ctx);
  }
  ...
  virtual std::any visitFunctionBody(CParser::FunctionBodyContext *ctx) override {
    return visitChildren(ctx);
  }
  ...
  virtual std::any visitGnuArrayDesignator(CParser::GnuArrayDesignatorContext *ctx) override {
    return visitChildren(ctx);
  }

  virtual std::any visitGnuIdentifier(CParser::GnuIdentifierContext *ctx) override {
    return visitChildren(ctx);
  }

  virtual std::any visitAsmArgument(CParser::AsmArgumentContext *ctx) override {
    return visitChildren(ctx);
  }

  virtual std::any visitAsmClobbers(CParser::AsmClobbersContext *ctx) override {
    return visitChildren(ctx);
  }

  virtual std::any visitAsmDefinition(CParser::AsmDefinitionContext *ctx) override {
    return visitChildren(ctx);
  }

  virtual std::any visitToplevelAsmArgument(CParser::ToplevelAsmArgumentContext *ctx) override {
    return visitChildren(ctx);
  }

  virtual std::any visitAsmOperand(CParser::AsmOperandContext *ctx) override {
    return visitChildren(ctx);
  }

  virtual std::any visitAsmOperands(CParser::AsmOperandsContext *ctx) override {
    return visitChildren(ctx);
  }

  virtual std::any visitAsmQualifier(CParser::AsmQualifierContext *ctx) override {
    return visitChildren(ctx);
  }

  virtual std::any visitAsmQualifierList(CParser::AsmQualifierListContext *ctx) override {
    return visitChildren(ctx);
  }

  virtual std::any visitAsmStatement(CParser::AsmStatementContext *ctx) override {
    return visitChildren(ctx);
  }

  virtual std::any visitAsmStringLiteral(CParser::AsmStringLiteralContext *ctx) override {
    return visitChildren(ctx);
  }
  ...
  virtual std::any visitGnuAttribute(CParser::GnuAttributeContext *ctx) override {
    return visitChildren(ctx);
  }

  virtual std::any visitGnuAttributeList(CParser::GnuAttributeListContext *ctx) override {
    return visitChildren(ctx);
  }

  virtual std::any visitGnuAttributes(CParser::GnuAttributesContext *ctx) override {
    return visitChildren(ctx);
  }

  virtual std::any visitGnuSingleAttribute(CParser::GnuSingleAttributeContext *ctx) override {
    return visitChildren(ctx);
  }

  virtual std::any visitSimpleAsmExpr(CParser::SimpleAsmExprContext *ctx) override {
    return visitChildren(ctx);
  }
