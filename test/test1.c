...
// |-TypedefDecl 0x55776fe34378 <<invalid sloc>> <invalid sloc> implicit __uint128_t 'unsigned __int128'
// | `-BuiltinType 0x55776fe340c0 'unsigned __int128'
// |-TypedefDecl 0x55776fe34680 <<invalid sloc>> <invalid sloc> implicit __NSConstantString 'struct __NSConstantString_tag'
// | `-RecordType 0x55776fe34450 'struct __NSConstantString_tag'
// |   `-Record 0x55776fe343d0 '__NSConstantString_tag'
// |-TypedefDecl 0x55776fe34728 <<invalid sloc>> <invalid sloc> implicit __builtin_ms_va_list 'char *'
// | `-PointerType 0x55776fe346e0 'char *'
// |   `-BuiltinType 0x55776fe33b80 'char'
// |-TypedefDecl 0x55776fe34a20 <<invalid sloc>> <invalid sloc> implicit __builtin_va_list 'struct __va_list_tag[1]'
// | `-ConstantArrayType 0x55776fe349c0 'struct __va_list_tag[1]' 1 
// |   `-RecordType 0x55776fe34800 'struct __va_list_tag'
// |     `-Record 0x55776fe34780 '__va_list_tag'
...
// |     |       | `-DeclRefExpr 0x55776fe94120 <col:20> 'int' lvalue ParmVar 0x55776fe93ed8 'b' 'int'
// |     |       `-IntegerLiteral 0x55776fe94140 <col:24> 'int' 2
// |     `-CompoundStmt 0x55776fe94240 <line:10:5, line:12:5>
// |       `-ReturnStmt 0x55776fe94230 <line:11:9, col:16>
// |         `-ImplicitCastExpr 0x55776fe94218 <col:16> 'int' <LValueToRValue>
// |           `-DeclRefExpr 0x55776fe941f8 <col:16> 'int' lvalue Var 0x55776fe93d70 'test_var_a' 'int'
...
//     |   | `-DeclRefExpr 0x55776fe944b8 <col:9> 'int (int, int)' Function 0x55776fe93fb8 'test_fun' 'int (int, int)'
//     |   |-ImplicitCastExpr 0x55776fe94598 <col:18> 'int' <LValueToRValue>
//     |   | `-DeclRefExpr 0x55776fe944d8 <col:18> 'int' lvalue Var 0x55776fe93d70 'test_var_a' 'int'
//     |   `-IntegerLiteral 0x55776fe944f8 <col:30> 'int' 13
