...
// ============================================================
//  Construction — mirrors CLexerBase.java constructor:
//    public CLexerBase(CharStream input) {
//        super(runGccAndMakeStream(input));
//    }
//  Uses C++ delegating constructor to achieve the same effect.
// ============================================================
...
// ============================================================
//  runGccAndMakeStream() — 1:1 port of CLexerBase.java
// ============================================================
...
// ============================================================
//  Argument helpers — same semantics as CLexerBase.java
// ============================================================
